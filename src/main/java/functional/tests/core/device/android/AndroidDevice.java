...
public class AndroidDevice implements IDevice {
     ...
     * Explain when to use AndroidDevice().
     */
    ...
    /**
     * TODO(svetli): Add docs.
     * Explain when to use AndroidDevice(Context context).
     *
     * @param context
     */
    ...
    public IOSDevice ios() {
        LOGGER_BASE.error("This method is not implemented for Android.");
        return null;
    }
    ...
    public void runAppInBackGround(int seconds) {
        ...
        this.context.wait.sleep(seconds * 1000);
        this.adb.runAdbCommand(this.getId(), "shell monkey -p " + this.context.app.getId() + " -c android.intent.category.LAUNCHER 1");
