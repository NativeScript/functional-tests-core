...
public class NavigationManager {
    ...
    /**
     * TODO(): Add docs.
     * Explain when to use NavigationManager(MobileContext context)
     *
     * @param mobileContext
     */
    public NavigationManager(MobileContext mobileContext) {
    ...
    public void setMainPage(String mainPage) {
        ...
        if (!this.mainPage.isEmpty() && this.mobileContext.settings.platform == PlatformType.Android) {
    ...
    public void resetNavigationToLastOpenedPage() {
        ...
        if (this.usedPages.size() > 0) {
            ...
            NavigationHelper.navigateTo(pagesToNavigateToAsString, this, this.mobileContext, this.scrollToElementRetriesCount);
        } else {
            if (this.mainPage != null && this.mainPage != "") {
                NavigationHelper.navigateTo(this.mainPage, this, this.mobileContext, this.scrollToElementRetriesCount);
            }
        }
    }
    ...
    public void resetNavigationMainPage() {
        ...
        if (this.mobileContext.wait.waitForVisible(this.mobileContext.locators.byText(this.mainPage)) != null) {
            NavigationHelper.navigateTo(this.mainPage, this, this.mobileContext, this.scrollToElementRetriesCount);
        }
    }
    ...
    public boolean navigateTo(String demoPath) {
        ...
        return NavigationHelper.navigateTo(demoPath, this, this.mobileContext, this.scrollToElementRetriesCount);
    }
    ...
    public void navigateBack() {
        if (this.getLevel() > 0) {
            this.updatePagesOnNavigateBack();
            NavigationHelper.navigateBack(this.mobileContext);
    ...
    public void navigateForward() {
        ...
        NavigationHelper.navigateForward(this.mobileContext);
    }
