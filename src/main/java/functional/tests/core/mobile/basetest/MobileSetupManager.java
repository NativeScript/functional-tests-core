...
public class MobileSetupManager {
    ...
    private MobileSetupManager() {
        this.context = new MobileContext();
    }
     ...
     */
    public static MobileSetupManager initTestSetupBasic() {
        ...
        if (!MobileSetupManager.initSettings.containsKey(getAppConfig())) {
            ...
            mobileSetupManager.context.settings = new MobileSettings();
            mobileSetupManager.context.log = new Log();
    ...
    public void setContext(MobileContext context) {
