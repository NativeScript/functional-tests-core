...
import common.Exceptions.UnknownDeviceTypeException;
import common.Exceptions.UnknownOSException;
...
public class Settings {
    ...
    public static final String templatePath = userDir + File.separator + "resources" + File.separator + "templates";
    ...
    public static void initSettings() throws Exception {
        ...
        Log.info("Logger Tempalate Path: " + templatePath);
        Log.info("=============================================");
        Log.info("");
    }
}
